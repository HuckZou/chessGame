...
public class FlounderKnight extends Piece {
	
	public FlounderKnight(int pieceLocation, PieceColor pieceColor) {
	...
	@Override
	public FlounderKnight movePiece(Move move) {
		return new FlounderKnight(move.getDestLocation(), move.getActivePiece().getPieceColor());
	}
